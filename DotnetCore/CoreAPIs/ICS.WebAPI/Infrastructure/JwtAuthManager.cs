...
namespace ICS.WebAPI.Infrastructure
{
    public interface IJwtAuthManager
    {
        ...
        JwtAuthResult GenerateTokens(string userID, Claim[] claims, DateTime now);
        JwtAuthResult Refresh(string refreshToken, string accessToken, DateTime now, string userID);
    ...
    public class JwtAuthManager : IJwtAuthManager
    {
        ...
        public JwtAuthResult Refresh(string refreshToken, string accessToken, DateTime now, string userID)
        {
